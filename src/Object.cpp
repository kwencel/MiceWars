...
Object::Object(int x, int y, int width, int height, std::string img_path)
    : pos_x(x), pos_y(y), obj_width(width), obj_height(height) {
...
Object::Object(Point center, int width, int height, std::string img_path)
    : Object(center.x - (width / 2), center.y - (height / 2), width, height, img_path) { }
